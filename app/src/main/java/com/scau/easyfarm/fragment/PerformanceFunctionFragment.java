...
public class PerformanceFunctionFragment extends BaseFunctionFragment{
    ...
    public void initModuleList() {
        ...
        if (Module.existModule(u.getModuleList(), Module.MODULE_PERFORMANCE_STATISTICS_EXPERT)){
            Module performanceStatisticsExpert = new Module(SimpleBackPage.MYPERFORMANCE_MONTH_STATISTICS,"业绩统计",R.drawable.func_village_service_performance_icon,null);
        ...
        if (Module.existModule(u.getModuleList(), Module.MODULE_PERFORMANCE_STATISTICS_VERIFIER)){
            Module performanceStatisticsVerifier = new Module(SimpleBackPage.PERFORMANCE_MONTH_STATISTICS,"业绩统计",R.drawable.func_village_service_performance_icon,null);
