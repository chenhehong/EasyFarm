 ...
 */
public class ServiceMonthStatisticsFragment extends BaseListFragment<ServiceStatistics> implements
        AdapterView.OnItemLongClickListener{

    private static final String CACHE_KEY_PREFIX = "service_month_statistics_list_";
...
//      监听用户登录状态的广播
    ...
    @Override
//  重载设置子类的列表适配器
    protected ServiceMonthStatisticsAdapter getListAdapter() {
        return new ServiceMonthStatisticsAdapter();
    }
...
//            如果需要做搜索功能，可以通过bundle传人参数，进行带参数的请求
        ...
        EasyFarmServerApi.getMonthStaticsServiceList(mCatalog, mCurrentPage, mHandler);
    }
...
//  重载点击事件，自定义子类的点击事件
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        if (serviceStatistics != null) {
            UIHelper.showServiceStatistics(this, serviceStatistics.getMonth());
        }
    }
