 ...
 */
public class NewsListFragment extends BaseListFragment<VillageService> implements
...
//          UIHelper.showVillageServiceDetail(view.getContext(), villageService.getId());
    ...
    protected void openBrower() {
        Uri uri = Uri.parse("http://125.88.25.226:8006/easyfarm/front/news/base/getArticle?article=1");
