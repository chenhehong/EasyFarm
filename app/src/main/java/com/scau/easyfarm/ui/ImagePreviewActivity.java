...
import com.scau.easyfarm.adapter.RecyclingPagerAdapter;
import com.scau.easyfarm.base.BaseActivity;
import com.scau.easyfarm.ui.dialog.ImageMenuDialog;
import com.scau.easyfarm.util.TDevice;
import com.scau.easyfarm.widget.HackyViewPager;
...
public class ImagePreviewActivity extends BaseActivity implements
    ...
    private void saveImg() {
        if (mAdapter != null && mAdapter.getCount() > 0) {
            ...
            AppContext.showToastShort("图片已保存(手机相册-> EasyFarm)"+filePath);
        } else {
            AppContext.showToastShort("无法保存图片");
        }
    }
