 ...
 * 知识库类别列表适配器
 */
public class ServiceStatisticsAdapter extends ListBaseAdapter<VillageService>{
    ...
    public ServiceStatisticsAdapter(Fragment fragment) {
    ...
    protected View getRealView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || convertView.getTag() == null) {
            convertView = getLayoutInflater(parent.getContext()).inflate(R.layout.list_cell_service_statistics, null);
