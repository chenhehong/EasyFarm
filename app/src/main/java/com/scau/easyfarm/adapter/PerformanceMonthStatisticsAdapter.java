 ...
 * 知识库类别列表适配器
 */
public class PerformanceMonthStatisticsAdapter extends ListBaseAdapter<PerformanceStatistics>{
    ...
    protected View getRealView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || convertView.getTag() == null) {
            convertView = getLayoutInflater(parent.getContext()).inflate(R.layout.list_cell_performance_month_statistics, null);
