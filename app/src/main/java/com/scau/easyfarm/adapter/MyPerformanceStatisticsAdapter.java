 ...
 * 知识库类别列表适配器
 */
public class MyPerformanceStatisticsAdapter extends ListBaseAdapter<Performance>{
    ...
    protected View getRealView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || convertView.getTag() == null) {
            convertView = getLayoutInflater(parent.getContext()).inflate(R.layout.list_cell_myperformance_statistics, null);
